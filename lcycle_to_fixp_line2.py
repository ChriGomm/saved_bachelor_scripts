...
# while True:
#     if os.path.exists('/home/christian/Documents/Bachelor/numerics/mean_field/4.4k13_1.5w5.5_3d/means_750line_10k_bay_2.694d2.64.npy'):
#         # sleep(5*60)
#         break
#     sleep(60*60)
print('start')
...
name = '_1000line_10k_1.742d1.727'
namenp = name + '.npy'
...
# d = np.linspace(-1.8,-1.705,gridpoints)
# d = np.linspace(-1.72415,-1.72405,gridpoints)
# d = np.linspace(-1.85, -1.66,gridpoints)
d = np.linspace(-1.742,-1.727,gridpoints)
w = 2.3889

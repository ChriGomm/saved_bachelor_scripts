...
while True:
    ...
    if os.path.exists('/home/christian/Documents/Bachelor/numerics/mean_field/4.4k13_1.5w5.5_3d/aver_750line_10k_bay_2.798d2.74.npy'):
        sleep(5*60)
        break
    sleep(60*60)
print('start')
root_path = '/home/christian/Documents/Bachelor/numerics/mean_field/4.4k13_1.5w5.5_3d/'
name = '_750line_10k_bay_2.6d2.55'
namenp = name + '.npy'
...
d = np.linspace(-2.6, -2.55,gridpoints)
w = 2.3889

...
# while True:
#     if os.path.exists('/home/christian/Documents/Bachelor/numerics/mean_field/4.4k13_1.5w5.5_3d/DOP_w_cutarray_p.npy'):
#         sleep(5*60)
#         break
#     sleep(60*60)
print('start')
...
d = np.linspace(-2.287, -1.6,gridpoints)
w = 2.3889
